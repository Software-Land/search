...
function randomFeatures(rng) {
  ...
  return {
    ...
    configuredEquivalenceMatch: pick(rng, [false, false, "key-in-title", "expansion"]),
...
describe("ranking equivalence oracle", () => {
  ...
  test("contextual prefix, coverage, surface/lemma, version, dotted span, title length, short literal", () => {
    rankBoth([
      ...
      hit("surface", { queryTokenCount: 1, typedSurfaceTitleMatch: true, configuredEquivalenceMatch: false }),
      hit("lemma", { queryTokenCount: 1, typedSurfaceTitleMatch: false, configuredEquivalenceMatch: false }),
