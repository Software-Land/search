...
The mixed generator plants rare exact titles, version/dotted-span documents, a configured-concept entry, morphology lemmas, and a two-node relationship, then fills the rest with settings-like and article-like documents (overlapping vocabulary, not a toy exclusive to indexed retrieval).
